...
const AboutAline = () => {
    return (
      <section>
        ...
        <p>Welcome to Aline - Your One-Stop Solution for local events weather you're taking it solo or with friends!</p> 
        ...
        <h2>Our Story</h2> 
        <p>Aline emerged from a group project that turned into a mission-driven venture.
        ...
        <h2>Our Mission</h2>
         <p>Our mission is to make finding local events and their prices accessible and effective for everyone.
        ...
        <h2>Meet Our Team</h2>
         ...
         <div className="team-member">
         <h3>[Chris P]</h3> <p>[Front-end and Back-end Engineer]</p> <p>[Brief bio]</p> </div>

         <div className="team-member">
         <h3>[Dimintri Lo]</h3> <p>[Front-end Engineer]</p> <p>[Brief bio]</p> </div>

         <div className="team-member">
         <h3>[Josh Askew]</h3> <p>[Front-end and Back-end Engineer]</p> <p>[Brief bio]</p> </div>

        <h2>Get in Touch</h2>
         <p>We are here to assist you with any questions or support you might need. Feel free to <a href="https://github.com/JoshAskew/Aline-Events">Contact Us</a>
          or follow us on (social media links) to stay updated with the latest from Aline. Together, let's achieve greatness!</p>
      </section>
  );
};
